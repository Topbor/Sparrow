            ...
            <div id="primary" class="eight columns portfolio-list">
               ...
               <div class="filter">
                  ...
                  <div class="fpoint" style="display:none;">
                     <div style="display:flex; width:100%; justify-content:space-around; margin:0 auto;">
                     <p style="text-align:center; padding:10px; border:1px solid grey; border-radius:5px; width:30%;"><a href="{{route('lhige')}}" style="font-size:18px;  color:grey; ">Висока</a></p>
                     ...
                     <p style="">
                     <form action="{{route('hige')}}" method="post">
                     @csrf
