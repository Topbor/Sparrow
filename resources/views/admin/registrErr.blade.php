...
<div id="page-content" style="text-align:center;" class="row h">
    <h1>Реєстрація</h1>
    <h2>Поля заповнено не коректно</h2>
    <form action="{{route('admin.registration')}}" method="POST" style="border:1px solid white">
    @csrf
        <p>Ваше ім'я</p>
        <input type="text" name="fn" style="border:1px solid red; background:white; width:50%;border-radius:5px; margin:0 auto;" placeholder="First name">
        <p>Ваше прізвище</p>
        <input type="text" name="ln" style="border:1px solid red; background:white; width:50%;border-radius:5px; margin:0 auto;" placeholder="Last name">
        <p>Ведіть логін</p>
