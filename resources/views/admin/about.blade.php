         ...
         <div id="primary" class="eight columns">
            ...
            <section>
               ...
               <div class="sub" style="background: #0a7d00; padding: 10px;
                  ...
                  <a href="{{route('admin.new.guide')}}" style="color:white;">Додати нового</a></div>
                  ...
                  <div id="team-wrapper" class="bgrid-halves cf">
                     ...
                     <div class="column member">
                        ...
                        <div class="member-name">
                           <h5><a href="{{route('admin.guide.view', ['id' => $g->id])}}">{{$g->first_name}} {{$g->last_name}}</a></h5>
                           <span>{{$g->posada}}</span>
                           ...
                           <a style="color:white;" href="{{route('admin.update.guide',['id'=>$g->id])}}"><i class="fas fa-edit"></i></a></div>
                           <div style="padding:5px; padding-right:20px; padding-left:20px; background:#f20000; border-radius:3px;">
                           <a style="color:white;" href="{{route('admin.delete.guide',['id'=>$g->id])}}"><i class="fas fa-trash"></i></a></div>
                        </div>
                        </div>
