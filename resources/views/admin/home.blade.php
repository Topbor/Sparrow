...
@section('adm', "Ви ввійшли як $admin->first_name $admin->last_name"  )
               ...
               <div class="item-wrap">
                     ...
                     <div class="link-icon"><i class="fa fa-link"></i></div>
    					...
    					<div class="portfolio-item-meta">
    					   <h5><a href="{{route('admin.tours')}}">Еверест</a></h5>
                     <p>Непал</p>
    					</div>
               </div>
    			</div>
            ...
            <div class="columns portfolio-item">
               <div class="item-wrap">
                     ...
                     <div class="link-icon"><i class="fa fa-link"></i></div>
    					...
    					<div class="portfolio-item-meta">
    					   <h5><a href="{{route('admin.tours')}}">Айленд пік</a></h5>
                     <p>Непал</p>
    					</div>
               </div>
    			</div>
            ...
            <div class="columns portfolio-item s-first">
               <div class="item-wrap">
                     ...
                     <div class="link-icon"><i class="fa fa-link"></i></div>
    					...
    					<div class="portfolio-item-meta">
    					   <h5><a href="{{route('admin.tours')}}">Монблан</a></h5>
                     <p>Франція</p>
    					</div>
               </div>
    			</div>
            ...
            <div class="columns portfolio-item">
               <div class="item-wrap">
                     ...
                     <div class="link-icon"><i class="fa fa-link"></i></div>
    					...
    					<div class="portfolio-item-meta">
    					   <h5><a href="{{route('admin.tours')}}">Ельбрус</a></h5>
                     <p>Росія</p>
    					</div>
               </div>
    			</div>
   ...
   <section id="journal">
      ...
      <div class="blog-entries">
         ...
         <article class="row entry">
            ...
            <div class="ten columns offset-2 post-content">
            <h3><a href="{{route('admin.tours')}}">Безпека учасників - головний пріоритет.</a></h3>
         ...
         <article class="row entry">
            ...
            <div class="ten columns offset-2 post-content">
            <h3><a href="{{route('admin.tours')}}">Гарантія сходження.</a></h3>
         ...
         <article class="row entry">
            ...
            <div class="ten columns offset-2 post-content">
            <h3><a href="{{route('admin.tours')}}">Тільки цікаві програми.</a></h3>
         ...
         <article class="row entry">
            ...
            <div class="ten columns offset-2 post-content">
            <h3><a href="{{route('admin.tours')}}">Знижки та бонуси.</a></h3>
         ...
         <article class="row entry">
            ...
            <div class="ten columns offset-2 post-content">
            <h3><a href="{{route('admin.tours')}}">Допомога при підготовці.</a></h3>
   ...
   <section id="call-to-action">
      ...
      <div class="row">
         ...
         <div class="three columns action">
            ...
            <a href="{{route('admin.tours')}}" class="button">Переглянути</a>
