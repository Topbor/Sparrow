...
<div id="page-content" style="text-align:center;" class="row h">
    ...
    <form action="{{route('admin.new.trip.store')}}" method="POST" style="border:1px solid red">
    @csrf
    <p style="font-size:20px; color:red;padding-top:20px">Поля заповнено не коректно</p>
        <p>Ведіть назву</p>
        <input type="text" name="trip" style="border:1px solid red; background:white; border-radius:5px; width:40%; margin:0 auto; margin-bottom:10px;" placeholder="Trip_title">
        <p>Виберіть туp</p>
        ...
        <input type="number" name="price" placeholder="Price" style="padding:20px;font-size:15px;color:#647373;border:1px solid red;background:white; width:40%; border-radius:5px; margin:0 auto;  margin-bottom:10px;" id=""> 
