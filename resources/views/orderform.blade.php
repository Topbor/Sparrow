...
<div id="page-content" style="text-align:center;" class="row h">
    ...
    @forelse ($i as $ii)
    <form action="{{route('order.store',$ii)}}" method="POST" style="border:1px solid white">
    @csrf
        <p>Ведіть ваше ім'я</p>
        <input type="text" name="name" style="border:none; border-radius:5px; margin:0 auto;" placeholder="Name">
        <p>Введіть ваш номер телефону</p>
        +380 <input type="number" name="phone" placeholder="Phone" style="border:none; border-radius:5px;  margin-bottom:20px;" id=""> 
